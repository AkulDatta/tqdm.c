...
static bool test_tqdm_for_array_strings(void) {
    ...
    TEST_ASSERT(iteration_count == 5, "Expected 5 iterations");
    TEST_ASSERT(total_length == 25, "Expected total length of 25"); /* hello(5) + world(5) + tqdm(4) + progress(8) + bar(3) = 25 */
...
static bool test_macro_memory_safety(void) {
    ...
    for (int test = 0; test < 3; test++) {
        ...
        TEST_ASSERT(iteration_count == 3, "Each array test should have 3 iterations");
    }
...
int main(void) {
    ...
    bool (*tests[])(void) = {
        test_tqdm_for_basic,
        test_tqdm_for_negative,
        test_tqdm_for_step,
        test_tqdm_for_step_large,
        test_tqdm_for_array,
        test_tqdm_for_array_strings,
        test_tqdm_manual,
        test_tqdm_manual_nested,
        test_nested_macros,
        test_macro_with_break,
        test_macro_with_continue,
        test_macro_memory_safety,
    };
